...
import 'package:finalyearproject/Services/handleerrormessage.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  loginapicall(BuildContext context) async {
    try {
      ...
      final response = await DioClient.instance.login(loginrequest);
    
      Helper.showShortToastSuccess("Successfully Logged In");
